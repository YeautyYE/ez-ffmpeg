...
// status: verified shape V4 (single-frame thumbnail (input -ss, -an, mjpeg)) — verified by the manifest-driven semantic golden suite (oracle: Thumbnail) against the ffmpeg CLI; canonical emission compile-pinned as examples/cli_emitted_thumbnail/main.rs
