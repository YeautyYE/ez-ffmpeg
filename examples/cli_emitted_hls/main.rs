...
// status: verified shape V6 (single-rendition VOD HLS) — verified by the manifest-driven semantic golden suite (oracle: Hls) against the ffmpeg CLI; canonical emission compile-pinned as examples/cli_emitted_hls/main.rs
