...
// status: verified shape V2 (re-encoded clip (input -ss, output -t)) — verified by the manifest-driven semantic golden suite (oracle: Clip) against the ffmpeg CLI; canonical emission compile-pinned as examples/cli_emitted_clip/main.rs
