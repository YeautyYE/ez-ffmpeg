...
// status: verified shape V5 (scaled H.264/AAC transcode (-vf scale)) — verified by the manifest-driven semantic golden suite (oracle: Scale) against the ffmpeg CLI; canonical emission compile-pinned as examples/cli_emitted_scale/main.rs
