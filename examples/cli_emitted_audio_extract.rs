...
// status: verified shape V3 (audio extract (-vn, AAC)) — backed by the semantic golden `golden_v3_audio_extract` against the ffmpeg CLI; canonical emission compile-pinned as examples/cli_emitted_audio_extract.rs
