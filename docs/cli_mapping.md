...
| `-vf` / `-af` / `-filter_complex` | filter | builder [`filter_desc`](crate::core::context::ffmpeg_context_builder::FfmpegContextBuilder::filter_desc) | Full filtergraph syntax including labels and multiple inputs. |
